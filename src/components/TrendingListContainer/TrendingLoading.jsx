...
export const TrendingLoading = () => {
  ...
  const Loading = Array.from({ length: 5 }).map(
    (_, i)=>(
      <div
      ...
      >
        ...
        <div className="info">
          ...
          <p style={{ background: color.backgroundTextLoading }}>
            ...
            pero en una ironía de la historia podemos detenernos de ir al
            espacio cuanto más lo hagamos. Con cada cohete lanzado estamos
            creando una trampa mortal para la humanidad.
          </p>
